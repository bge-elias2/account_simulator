...
initial_account_value =  0 # whatever you want you intitial account balance to be
account_value = initial_account_value
max_concurrent_trades = 0 # how many trades are you willing to be in at once
active_trades = []
...
file_path_to_export = 'your path'  # Specify your desired file path
